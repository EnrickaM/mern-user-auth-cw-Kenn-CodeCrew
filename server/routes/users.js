...
var UserEmailCollection = require('../models/UserEmailsSchema');
...
passport.use('signup', new LocalStrategy(
    ...
    function(req, username, password, done) {
        ...
        findOrCreateUser = function(){
            ...
            UserEmailCollection.findOne({'username':username},function(err, user) {
                ...
                if (user) {
                    ...
                    // create the user
                    var newUser = new UserEmailCollection();
